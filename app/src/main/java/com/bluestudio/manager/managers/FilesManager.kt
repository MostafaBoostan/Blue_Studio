...
class FilesManager(
    ...
    private val onUpdateFiles: ((files: List<com.bluestudio.manager.model.MicroFile>) -> Unit)? = null
) {
     ...
     */
    fun remove(file: com.bluestudio.manager.model.MicroFile) {
     ...
     */
    fun new(file: com.bluestudio.manager.model.MicroFile) {
     ...
     */
    fun rename(src: com.bluestudio.manager.model.MicroFile, dst: com.bluestudio.manager.model.MicroFile) {
    ...
    private fun decodeFiles(json: String) {
        val list = mutableListOf<com.bluestudio.manager.model.MicroFile>()
