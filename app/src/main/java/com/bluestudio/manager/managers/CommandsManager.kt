...
object CommandsManager {
     ...
     * @return The MicroPython command string.
     */
    fun removeFile(file: com.bluestudio.manager.model.MicroFile): String {
     ...
     * @return The MicroPython command string.
     */
    fun removeDirectory(file: com.bluestudio.manager.model.MicroFile): String {
     ...
     * @return The MicroPython command string.
     */
    fun makeDirectory(file: com.bluestudio.manager.model.MicroFile): String {
     ...
     * @return The MicroPython command string.
     */
    fun makeFile(file: com.bluestudio.manager.model.MicroFile): String {
     ...
     * @return The MicroPython command string.
     */
    fun rename(src: com.bluestudio.manager.model.MicroFile, dst: com.bluestudio.manager.model.MicroFile): String {
