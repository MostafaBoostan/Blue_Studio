...
class ScriptsManager(private val context: Context) {
     ...
     */
    val scripts = mutableStateListOf<com.bluestudio.manager.model.MicroScript>()
    ...
    private fun updateScriptsList() {
        val list = mutableListOf<com.bluestudio.manager.model.MicroScript>()
        scriptDirectory()?.let { it ->
            it.listFiles()?.forEach { file ->
                val path = file.absolutePath
                val script =
                    _root_ide_package_.com.bluestudio.manager.model.MicroScript(path = path)
                list.add(script)
            }
        }
        scripts.clear()
     ...
     */
    fun deleteScript(script: com.bluestudio.manager.model.MicroScript) {
        val b = delete(script)
     ...
     */
    fun renameScript(script: com.bluestudio.manager.model.MicroScript, newName: String) {
     ...
     */
    fun shareScript(script: com.bluestudio.manager.model.MicroScript) {
     ...
     */
    private fun delete(script: com.bluestudio.manager.model.MicroScript): Boolean {
        val file = script.file
     ...
     */
    private fun rename(script: com.bluestudio.manager.model.MicroScript, newName: String): Boolean {
